...
public class Manip_array {
	...
	public static void main (String[]args) {
		...
		while (menu==true) {
			System.out.println("Sistema de gera��o e analise de numeros.");
			...
			case 1:
				while (menu2==true) {
					...
					if (k==0) {
						...
						System.out.print("\nMediana: "+mediana);
						System.out.print("\nA variancia dos numeros gerados �: "+variancia);
						System.out.print("\nO desvio padr�o dos numeros gerados �: "+desvp);
			...
			case 2:
				...
				break;
			default:
				System.out.println("\nop��o invalida!!! aperte <enter>");
				clearbuffer(ent);
				@SuppressWarnings("unused") String a = ent.nextLine();
				System.out.println("\n\n\n\n\n\n\n");
				break;
			}
		}
